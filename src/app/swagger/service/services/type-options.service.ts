...
export class TypeOptionsService extends BaseService {
  ...
  context?: HttpContext
...
): Observable<StrictHttpResponse<TypeOptionDto>> {
    ...
    return this.http.request(rb.build({
      ...
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<TypeOptionDto>;
      })
    );
  }
...
): Observable<TypeOptionDto> {

    return this.getTypeOptionsById$Response(params,context).pipe(
      map((r: StrictHttpResponse<TypeOptionDto>) => r.body as TypeOptionDto)
    );
  }
  ...
  context?: HttpContext
...
): Observable<StrictHttpResponse<Array<TypeOptionDto>>> {
    ...
    return this.http.request(rb.build({
      ...
      filter((r: any) => r instanceof HttpResponse),
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<Array<TypeOptionDto>>;
      })
    );
  }
...
): Observable<Array<TypeOptionDto>> {

    return this.getTypeOptions$Response(params,context).pipe(
      map((r: StrictHttpResponse<Array<TypeOptionDto>>) => r.body as Array<TypeOptionDto>)
    );
  }
